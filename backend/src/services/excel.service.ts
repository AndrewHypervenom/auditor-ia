...
class ExcelService {
 ...
 try {
 criteria = await getDatabaseService().getCriteriaForCallType(auditInput.callType, auditInput.subCalificacion, auditInput.companyId ?? undefined) as EvaluationBlock[];
 } catch (err: any) {
